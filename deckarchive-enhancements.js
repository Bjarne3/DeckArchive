...
Out came Raffine from Bjarne's side in order to outvalue the rest, but drawing cards was not an option with Sheoldred on the table. Pointing his resources towards Shelly, he had little to respond to Pieter and Lenny's beating and was out first again. Unsatisfied, he left. The other three battled it out, and the monoblack value pile took the win.`,
  ...
  const NATIVE_DECK_RATINGS = {
    ...
    "Joost's Mono-Black Deck": { owner: "Joost", salt: 7.5, scores: { oppressiveness: 6.5, winThreat: 8, interaction: 6, tablePanic: 7.5, turnCrimes: 2, politics: 4, funToFace: 7, podLore: 10 } },
    "Teysa Karlov": { owner: "Lenny", salt: 8, scores: { oppressiveness: 4, winThreat: 9, interaction: 5, tablePanic: 9, turnCrimes: 7, politics: 4, funToFace: 5, podLore: 10 } },
    ...
    "Karlov of the Ghost Council": { owner: "Joost", salt: 9, scores: { oppressiveness: 9, winThreat: 8, interaction: 6, tablePanic: 9, turnCrimes: 2, politics: 5, funToFace: 5, podLore: 8 } },
    ...
    "Raffine, Scheming Seer": { owner: "Bjarne", salt: 8, scores: { oppressiveness: 10, winThreat: 9, interaction: 8, tablePanic: 8, turnCrimes: 9, politics: 4, funToFace: 2, podLore: 6 } },
    "Obeka, Splitter of Seconds": { owner: "Bjarne", salt: 8, scores: { oppressiveness: 7, winThreat: 8, interaction: 6, tablePanic: 8, turnCrimes: 10, politics: 2, funToFace: 2, podLore: 8 } },
    "Kadena, Slinking Sorcerer": { owner: "Bjarne", salt: 9, scores: { oppressiveness: 10, winThreat: 10, interaction: 6, tablePanic: 9, turnCrimes: 8, politics: 3, funToFace: 5, podLore: 9 } },
  };
